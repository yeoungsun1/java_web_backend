...
public class LoginMain {
	public static void main(String[] args) {
		...
		//회원 목록에 회원 4명을 저장
		//사용자로부터 아이디와 비밀번호를 입력받기 Scanner
		...
		//[user.User@279f2327, user.User@2ff4acd0, user.User@54bedef2]
		users.add(new User("김영선", 20, "kys", "korea"));
		System.out.println(users);
